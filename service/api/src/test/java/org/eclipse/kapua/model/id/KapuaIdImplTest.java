...
public class KapuaIdImplTest extends Assert {
    ...
    public void equalsTest() {
        ...
        assertTrue("True expected.", kapuaIdImpl1.equals(kapuaIdImpl1));
        assertFalse("False expected", kapuaIdImpl1.equals(null));
        for (Object object : objects) {
            assertFalse("False expected", kapuaIdImpl1.equals(object));
        }
        assertFalse("False expected", kapuaIdImpl1.equals(kapuaIdImpl2));
        assertTrue("True expected", kapuaIdImpl1.equals(kapuaIdImpl3));
    }
}
