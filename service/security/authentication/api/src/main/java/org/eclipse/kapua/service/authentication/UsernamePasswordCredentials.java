...
@XmlType(propOrder = {"username", "password", "authenticationCode", "trustKey"}, factoryClass = AuthenticationXmlFactory.class, factoryMethod = "newUsernamePasswordCredentials")
