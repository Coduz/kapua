...
/**
 * OpenId {@link CredentialTypeHandler} implementation
 *
 * @since 2.1.0
 */
public class OpenIdCredentialTypeHandler implements CredentialTypeHandler {

    public static final String TYPE = "OpenId";

    private final AuthenticationUtils authenticationUtils;

    @Inject
    public OpenIdCredentialTypeHandler(AuthenticationUtils authenticationUtils) {
