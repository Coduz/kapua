...
public class DockerSteps {
     ...
     * @param dockerImage              full name of image (e.g. "kapua/kapua-broker:1.5.0-SNAPSHOT-COD")
    ...
    private ContainerConfig getDbContainerConfig() {
        ...
        return ContainerConfig.builder()
                ...
                .image("kapua/kapua-sql:1.5.0-SNAPSHOT-COD")
                .build();
    }
    ...
    private ContainerConfig getEventBrokerContainerConfig() {
        ...
        return ContainerConfig.builder()
                ...
                .image("kapua/kapua-events-broker:1.5.0-SNAPSHOT-COD")
                .build();
    }
